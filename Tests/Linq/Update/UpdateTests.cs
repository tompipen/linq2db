...
namespace Tests.xUpdate
{
	...
	public class UpdateTests : TestBase
	{
		...
		public void UpdateComplex1(string context)
		{
			using (var db = GetDataContext(context))
			{
				...
				try
				{
					...
					obj.Name.Name.LastName = obj.Name.Name.FirstName;

					db.Update(obj);

					obj = db.GetTable<ComplexPerson2>().First(_ => _.ID == id);

					Assert.AreEqual(obj.Name.Name.FirstName, obj.Name.Name.LastName);
				}
				finally
				{
					db.Person.Where(_ => _.FirstName.StartsWith("UpdateComplex")).Delete();
			...
			using (var db = GetDataContext(context))
			{
				...
				try
				{
					...
					var cnt = db.GetTable<ComplexPerson2>()
						.Where(_ => _.Name.Name.FirstName.StartsWith("UpdateComplex"))
						.Set(_ => _.Name.Name.LastName, _ => _.Name.Name.FirstName)
						.Update();
		...
		[Test, DataContextSource(ProviderName.Sybase, ProviderName.Informix), Explicit("Fails")]
