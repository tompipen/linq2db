...
namespace Tests.Linq
{
	...
	public class ParameterTests : TestBase
	{
		...
		[Test, DataContextSource(ProviderName.SqlCe, ProviderName.SQLite, TestProvName.SQLiteMs, ProviderName.PostgreSQL, ProviderName.Informix, ProviderName.DB2), Explicit("Fails")]
		...
		[Test, DataContextSource(ProviderName.SqlCe, ProviderName.SQLite, TestProvName.SQLiteMs, ProviderName.PostgreSQL, ProviderName.Informix, ProviderName.Informix, ProviderName.DB2), Explicit("Fails")]
		...
		[Test, DataContextSource(ProviderName.SqlCe, ProviderName.PostgreSQL, ProviderName.Informix, ProviderName.Informix, ProviderName.DB2, TestProvName.SQLiteMs), Explicit("Fails")]
